...
<body>
    ...
    $IdClient = "SELECT MAX('id_client') FROM client"; 
    $reservId = "INSERT INTO reservation (id_vol) VALUE ('$id')";
    $res = mysqli_query($con, $reservId);
    $_SESSION['idvol'] = $id;
    ?>
            ...
            <div class='modal-content'>
                ...
                <form action="confirmation.php" method="post">
                    ...
                    <div class='modal-footer'>
                        <input type="submit" name="submit" class="btn btn-primary" href="confirmation.php?id_vol=<?= $row['id_vol']; ?>" value='reserver' >
                    </div>
                </form>
            </div>
        </div>
